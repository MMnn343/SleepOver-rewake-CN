...
translate chinese strings:
    ...
    new "无障碍菜单。使用上下方向键移动，按回车激活按钮和滑条。"
    ...
    new "本菜单中的选项用于改善无障碍体验。它们不一定适用于所有游戏，某些选项组合可能导致游戏无法正常游玩。这不是游戏或引擎的问题。更换字体时，为获得最佳效果，请尽量保持原本的文字大小。"
    ...
    new "自定义 director.transforms 可添加更多变换。"
    ...
    new "自定义 director.transitions 可添加更多转场。"
    ...
    new "自定义 director.audio_channels 可添加更多频道。"
    ...
    new "确定要跳过未读对白直到下一个选项吗？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "这个存档是在另一台设备上创建的。恶意构造的存档文件可能会危害你的电脑。你信任这个存档的创建者，以及所有可能修改过该文件的人吗？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你信任创建该存档的设备吗？只有当你是该设备的唯一使用者时，才应选择“是”。"
    ...
    new "本程序包含多种许可证下的自由软件，包括 MIT 许可证和 GNU 宽通用公共许可证。完整软件列表以及源代码链接可在{a=https://www.renpy.org/l/license}此处{/a}查看。"
    ...
    new "自动朗读将读出“[renpy.display.tts.last]”。按 Alt+Shift+V 关闭。"
    ...
    new "Ren'Py 同步服务器没有这份同步数据。同步 ID 可能无效，或已经超时。"
    ...
    new "这会将你的存档上传到 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。\n要继续吗？"
    ...
    new "你可以用这个 ID 在另一台设备上下载存档。\n本次同步将在一小时后过期。\nRen'Py 同步服务由 {a=https://www.renpy.org/sponsors.html}Ren'Py 赞助者{/a}支持。"
    ...
    # renpy/common/00compat.rpy:459
    old "Fullscreen"
    new "全屏"

    # renpy/common/00gallery.rpy:676
    old "Image [index] of [count] locked."
    new "第 [index]/[count] 张图片已锁定。"
    ...
    new "显卡驱动可能已经过时，或运行不正常。这可能导致图形显示缓慢或异常。"
    ...
    old "Copy Markdown"
    new "将 traceback.txt 以 BBCode 格式复制到剪贴板，用于 https://lemmasoft.renai.us/ 等论坛。"
    ...
    new "将 traceback.txt 以 Markdown 格式复制到剪贴板，用于 Discord。"
